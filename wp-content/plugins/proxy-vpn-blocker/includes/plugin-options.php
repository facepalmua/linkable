...
class Proxy_VPN_Blocker_Settings {
	...
	public function add_menu_item() {
		...
		add_submenu_page( $this->parent->_token . '_settings', 'Blacklist', 'Blacklist', 'manage_options', $this->parent->_token . '_blacklist', array( $this, 'ipblacklist_page' ) );
		add_submenu_page( $this->parent->_token . '_settings', 'Whitelist', 'Whitelist', 'manage_options', $this->parent->_token . '_whitelist', array( $this, 'ipwhitelist_page' ) );
	...
	private function settings_fields() {
		...
		$settings['DeniedMessage']            = array(
			'title'       => __( 'Access Denied Message or Custom Blocked Page', 'proxy-vpn-blocker' ),
			'description' => __( 'You can edit the default Access Denied Page message or select your own page to display instead.', 'proxy-vpn-blocker' ),
			'fields'      => array(
				array(
