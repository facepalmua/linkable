...
if ( isset( $current_whitelist->status ) && 'denied' === $current_whitelist->status ) {
	...
	$html .= '<h1>' . __( 'Proxy &amp; VPN Blocker proxycheck.io Whitelist', 'proxy-vpn-blocker' ) . '</h1>' . "\n";
	...
	if ( !empty( $getapikey ) ) {
		...
		$html .= '<h2>' . __( 'proxycheck.io Whitelist', 'proxy-vpn-blocker' ) . '</h2>' . "\n";
		$html .= '<p>' . __( 'Here you can view and edit your proxycheck.io Whitelist.', 'proxy-vpn-blocker' ) . '</p>' . "\n";
