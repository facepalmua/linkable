...
class proxy_vpn_blocker {
	 ...
	 * @return  void
	 */
	public function __construct( $file = '', $version = '1.6.8' ) {
	...
	public function pvb_scripts_header_information_function() {
		...
		if ( strpos( $current_screen->base, 'proxy_vpn_blocker_statistics' ) === false ) {
			...
			wp_register_script( $this->_token . '-settings-pvb-amcharts-js', esc_url( $this->assets_url ) . 'js/amcharts/amcharts' . $this->script_suffix . '.js', array( 'jquery' ), $this->_version, false );
			wp_enqueue_script( $this->_token . '-settings-pvb-amcharts-js' );
			wp_register_script( $this->_token . '-settings-pvb-amcharts-pie-js', esc_url( $this->assets_url ) . 'js/amcharts/pie' . $this->script_suffix . '.js', array( 'jquery' ), $this->_version, false );
			wp_enqueue_script( $this->_token . '-settings-pvb-amcharts-pie-js' );
			wp_register_script( $this->_token . '-settings-pvb-amcharts-serial-js', esc_url( $this->assets_url ) . 'js/amcharts/serial' . $this->script_suffix . '.js', array( 'jquery' ), $this->_version, false );
			wp_enqueue_script( $this->_token . '-settings-pvb-amcharts-serial-js' );
			wp_register_script( $this->_token . '-settings-pvb-amcharts-light-js', esc_url( $this->assets_url ) . 'js/amcharts/light' . $this->script_suffix . '.js', array( 'jquery' ), $this->_version, false );
			wp_enqueue_script( $this->_token . '-settings-pvb-amcharts-light-js' );
			wp_register_script( $this->_token . '-settings-pvb-amcharts-dataloader-js', esc_url( $this->assets_url ) . 'js/amcharts/dataloader' . $this->script_suffix . '.js', array( 'jquery' ), $this->_version, false );
	 ...
	 */
	public static function instance( $file = '', $version = '1.6.8' ) {
