<?php
/**
 * Template Name: My Project NO Applications
 */
...
$user_role = ae_user_role( $user_ID );
define( 'NO_RESULT', __( '<span class="project-no-results">There are no projects to display here yet.', ET_DOMAIN ) );
...
?>
    ...
    <style>
        ...
        .employer-project-nav ul li:nth-child(4) a {
            color: #1aad4b;
            border-bottom: 1px solid #1faa49;
        }

        .project-sub-nav li:nth-child(4) a {
            color: white;
            font-weight: bold;
        }
                                    ...
                                    <div class="current-employer-project">
                                        <div class="fre-table">
                                            ...
                                            <div class="fre-current-table-rows">
												...
												if ( $no_app == 0 ) {
													echo 'Any project without any contracts would show up here. However, it currently looks like you do not have any yet for us to display here.';
												}
												...
												if ( empty( $bid_posts ) ) {
                                                    ...
                                                    <div class="fre-table-row no-app">
										...
										<?php }
											...
											$no_result_current = 'Any project without any contracts would show up here. However, it currently looks like you do not have any yet for us to display here.';
										}
										?>
                                        </div>
                                    </div>
