<?php
/**
 * Template Name: Author App - Declined
 */
                                                ...
                                                <div class="fre-all-contracts-table">
                                                    ...
                                                    <table style="width: 100%;">
                                                        <tr>
															...
															$deadlineOrderLink = get_site_url() . '/my-applications/declined';
...
<script>
    ...
    jQuery(".project-sub-nav li:nth-child(5)").addClass("active");
    jQuery(".nav-tabs-my-work li:nth-child(5)").addClass("active");
</script>