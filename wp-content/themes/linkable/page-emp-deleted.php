<?php
/**
 * Template Name: Employer Projects Completed and Deleted
 */
...
$user_role = ae_user_role( $user_ID );
define( 'NO_RESULT', __( '<span class="project-no-results">There are no projects to display here yet.</span>', ET_DOMAIN ) );
...
?>
    ...
    <style>
        ...
        .employer-project-nav ul li:nth-child(7) a {
            color: #1aad4b;
            border-bottom: 1px solid #1faa49;
        }

        .project-sub-nav li:nth-child(7) a {
            color: white;
            font-weight: bold;
        }
                            ...
                            <div id="current-project-tab" class="employer-current-project-tab fre-panel-tab active">
								...
								$employer_current_project_query = new WP_Query(
									array(
										...
										'order'            => 'DESC',
										'paged'            => $paged,
										'post_status'      => array( 'deleted', 'deleted-accepted-app' )
									)
                                ...
                                <div class="fre-work-project-box">
                                    <div class="current-employer-project">
                                        <div class="fre-table">
											...
											<?php get_template_part( 'employer-project-query' );
											wp_reset_query(); ?>
                                            ...
                                            <div class="fre-current-table-rows">
												...
												if ( $employer_current_project_query->have_posts() ) {
													...
													while ( $employer_current_project_query->have_posts() ) {
                                                        ...
                                                        <div class="fre-table-row deleted la-cm-project">
                                                            ...
                                                            <div class="project-footer-bar <?= $parent_status; ?>">
																<?php
																// echo $parent_status;
																echo '<div class="project-status-bar">';
																...
																//echo '<span class="project-header">Posted</span> ' . human_time_diff( get_the_time('U',$convert->post_parent), current_time('timestamp') ) . ' ago';

																//$time_posted = human_time_diff( get_the_time('U',$convert->post_parent), current_time('timestamp') );
													...
													$no_result_current = 'Any projects that have been deleted or expired would show up here. However, it currently looks like you do not have any yet for us to display here.';
												}
												?>
                                            </div>
                                        </div>
...
<?php get_footer(); ?>max( 1, get_query_var('paged') ),
    'total' => $wp_query->max_num_pages
    ) );
    ?>
    </nav>
