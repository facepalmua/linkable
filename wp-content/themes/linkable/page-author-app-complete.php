<?php
/**
 * Template Name: Author App - Complete
 */
...
$args = array(
	...
	'orderby'        => 'date',
	'order'          => 'DESC',
	'post_status'    => array( 'pending-completion', 'complete' ),
	'post_count'     => - 1,
	'posts_per_page' => - 1,
                                                ...
                                                <div class="fre-all-contracts-table">
                                                    ...
                                                    <table style="width: 100%;">
                                                        <tr>
															...
															$deadlineOrderLink = get_site_url() . '/my-applications/complete';
...
<script>
    ...
    jQuery(".project-sub-nav li:nth-child(4)").addClass("active");
    jQuery(".nav-tabs-my-work li:nth-child(4)").addClass("active");
</script>