<?php
/**
 * Template Name: My Project with CANCELLED apps
 */
...
?>
    ...
    <style>
        ...
        .employer-project-nav ul li:nth-child(6) a {
            color: #1aad4b;
            border-bottom: 1px solid #1faa49;
        }

        .project-sub-nav li:nth-child(6) a {
            color: white;
            font-weight: bold;
        }
                                    ...
                                    <div class="current-employer-project">
                                        <div class="fre-table">
                                            ...
                                            <div class="fre-current-table-rows">
                                                ...
                                                if ( $cancelled == 0 ) {
                                                    echo 'Any project with cancelled contracts would show up here. However, it currently looks like you do not have any yet for us to display here.';
                                                    ...
                                                    while ( $employer_current_project_query->have_posts() ) {
                                                        ...
                                                        if ( ! empty( $bid_posts ) ) {
                                                            ...
                                                            <div class="fre-table-row cancelled-app">
                                                    ...
                                                    $no_result_current = 'Any project with cancelled contracts would show up here. However, it currently looks like you do not have any yet for us to display here.';
                                                }
                                                ?>
                                            </div>
                                        </div>
