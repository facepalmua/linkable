...
function la_search_messages() {
	global $wpdb;
	$data = $_POST;
	$data['user_id'] = get_current_user_id();
	//echo json_encode($data);
	$tbl_messages = $wpdb->prefix . 'la_private_messages';
...
add_action( 'wp_ajax_la_search_messages', 'la_search_messages');
add_action( 'wp_ajax_nopriv_la_search_messages', 'la_search_messages');
