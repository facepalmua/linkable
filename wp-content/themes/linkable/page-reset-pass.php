		...
		<div class="container">
			<div class="fre-authen-wrapper">
				<div class="fre-authen-reset-pass">
					<h2><?php _e('Set a new password:', ET_DOMAIN);?></h2>
					<form role="form" id="resetpass_form" class="signin_form">
						...
						<div class="amt_err" style="display: none; color:red; margin-top: -20px; margin-bottom: 20px;"></div>
						<div class="fre-input-field">
							<input type="password" id="re_new_password" name="re_new_password" placeholder="<?php _e('Confirm new password', ET_DOMAIN);?>">
						</div>
						<div class="fre-input-field">
							<button class="fre-submit-btn btn-submit primary-bg-color"><?php _e('Change password', ET_DOMAIN);?></button>
						</div>
					</form>
				</div>
			</div>
