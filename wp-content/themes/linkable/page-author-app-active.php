<?php
/**
 * Template Name: Author App - Active
 */
                                                ...
                                                <div class="fre-all-contracts-table">
                                                    ...
                                                    <table style="width: 100%;">
                                                        <tr>
							                                ...
							                                $deadlineOrderLink = get_site_url() . '/my-applications/active';
                                                            ...
                                                            <th>Status</th>
                                                            <th>
                                                                <a href="<?= $deadlineOrderLink; ?>" style="color: inherit; ">Deadline <i class="fa fa-sort"></i></a>
                                                            </th>
...
<script>
    ...
    jQuery(".project-sub-nav li:nth-child(2)").addClass("active");
    jQuery(".nav-tabs-my-work li:nth-child(2)").addClass("active");
</script>