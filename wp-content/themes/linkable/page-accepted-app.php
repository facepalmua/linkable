<?php
/**
 * Template Name: My Project with ACCEPTED Applications
 */
...
?>
    ...
    <style>
        ...
        .employer-project-nav ul li:nth-child(3) a {
            color: #1aad4b;
            border-bottom: 1px solid #1faa49;
        }

        .project-sub-nav li:nth-child(3) a {
            color: white;
            font-weight: bold;
        }
                                    ...
                                    <div class="current-employer-project">
                                        <div class="fre-table">
                                            ...
                                            <div class="fre-current-table-rows">
												...
												if ( $with_accepted_app == 0 ) {
													echo 'Any project with accepted contracts (that are not yet completed) would show up here. However, it currently looks like you do not have any yet for us to display here.';
												...
												$bid_query = new WP_Query( array(
														...
														'post_parent'    => get_the_ID(),
														'posts_per_page' => - 1,
														'post_status'    => array( 'accept', 'admin-review' )
													)
												);
                                                ...
                                                <div class="fre-table-row accepted-app la-cm-project">
                                                    ...
                                                    <div class="project-footer-bar <?= $parent_status; ?>">
														...
														<?php if ( $parent_status != 'deleted' ) { ?><i
										...
										<?php }
											...
											$no_result_current = 'Any project with accepted contracts (that are not yet completed) would show up here. However, it currently looks like you do not have any yet for us to display here.';
										}
										?>
                                        </div>
                                    </div>
