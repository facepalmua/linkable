jQuery( "#stripe_connect" ).submit(function( event ) {
  event.preventDefault();
  jQuery.ajax({
    type : "get",
     url : example_ajax_obj.ajaxurl,
     data : {action: "stripe_register_user", user_id_data: jQuery(this).find('input[name="user_id"]').val()},
...
jQuery(document).ready(function ($) {
  ...
  for (i = 0; i < coll.length; i++) {
    ...
    // $("#gform_wrapper_18 .gform_footer").append("<span class='cm-send-note'>Note that most clients will typically reply back to your message ONLY if they are interested.</span>");
...
jQuery(window).load(function () {
    ...
    jQuery("#loginform").append("<div class='forgot-password'><a href='https://wordpress-257790-935760.cloudwaysapps.com/forgot-password/'>Forgot password?</a></div>");
...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        $('.freelancer-bidding .bid-nav a').on('click', function (e) {
