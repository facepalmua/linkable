<?php
/**
 * Template Name: Author App - Pending
 */
                                                ...
                                                <div class="fre-all-contracts-table">
                                                    ...
                                                    <table style="width: 100%;">
                                                        <tr>
															...
															$deadlineOrderLink = get_site_url() . '/my-applications/pending';
...
<script>
    ...
    jQuery(".project-sub-nav li:nth-child(3)").addClass("active");
    jQuery(".nav-tabs-my-work li:nth-child(3)").addClass("active");
</script>