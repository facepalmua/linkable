...
class AE_Wizard extends AE_Page {
	...
	public function notice_after_installing_theme() {
		...
		if ( isset( $wizard_status ) && ! $wizard_status ) {
            ...
            <div id="notice_wizard" class="et-updated">
                <p>
					<?php
					$msg = apply_filters( 'notice_after_installing_theme', sprintf( __( "You have just installed Freelanceengine theme, we recommend you follow through our <a href='%s'>setup wizard</a> to set up the basic configuration for your website! <a href='%s'>Close this message</a>", ET_DOMAIN ), admin_url( 'admin.php?page=et-wizard' ), add_query_arg( 'close_notices', '1' ) ) );
					echo $msg;
					?>
                </p>
            </div>
	...
	public function delete_sample_data() {
		...
		if ( $response['updated_op'] ) {
			...
			$et_option = $ae_option->get_all_current_options();
			unset( $et_option['social_user_role'] );
			update_option( 'et_options', $et_option );
            ...
            <div class="et-main-right">
                <div class="et-main-main clearfix inner-content" id="wizard-sample">
                    ...
                    <div class="title font-quicksand" style="padding-top:0;">
                        ...
                        <div class="desc small"><?php _e( 'The sample data includes some items for the list below: profile, project, etc.', ET_DOMAIN ) ?></div>
                    ...
                    <div class="desc" style="padding-top:0px;">
                        <div class="title font-quicksand sample-title">
                            <a target="_blank"
                               href="<?php echo admin_url( 'edit.php?post_type=place' ); ?>"><?php _e( 'Places', ET_DOMAIN ) ?></a>
                            <span class="description"><?php _e( 'Add new place types or modify the sample ones to suit your site style.', ET_DOMAIN ) ?></span>
                        </div>
                        <div class="title font-quicksand sample-title">
                            <a target="_blank"
                               href="<?php echo admin_url( 'edit-tags.php?taxonomy=place_category&post_type=place' ); ?>"><?php _e( 'Place Categories', ET_DOMAIN ) ?></a>
                            <span class="description"><?php _e( 'Add new categories or modify the sample data to match your directory business.', ET_DOMAIN ) ?></span>
                        </div>
                        <div class="title font-quicksand sample-title">
                            <a target="_blank"
                               href="<?php echo admin_url( 'edit-tags.php?taxonomy=location&post_type=place' ); ?>"><?php _e( 'Place Locations', ET_DOMAIN ) ?></a>
                            <span class="description"><?php _e( 'Add new locations or modify the sample data to match your directory business.', ET_DOMAIN ) ?></span>
                        </div>
                        <div class="title font-quicksand sample-title">
                            <a target="_blank"
                               href="<?php echo admin_url( 'edit.php?post_type=page' ); ?>"><?php _e( 'Pages', ET_DOMAIN ) ?></a>
                            <span class="description"><?php _e( 'Modify the sample "About us, Contact us, ..." pages or add your extra pages when needed.', ET_DOMAIN ) ?></span>
                        </div>
                        <div class="title font-quicksand sample-title">
                            <a target="_blank"
                               href="<?php echo admin_url( 'edit.php' ); ?>"><?php _e( 'Posts', ET_DOMAIN ) ?></a> <span
                                    class="description"><?php _e( 'A couple of news & event posts have been added for your review. You can delete it or add your own posts here.', ET_DOMAIN ) ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="et-main-main clearfix inner-content <?php if ( ! $sample_data_op ) {
                    ...
                    <div class="title font-quicksand sample-title">
                        <a target="_blank" href="edit.php?post_type=page"><?php _e( 'Front Page', ET_DOMAIN ) ?></a>
                        <span class="description"><?php _e( 'Rearrange content elements or add more information in your front page to suit your needs.', ET_DOMAIN ) ?></span>
                    </div>

                    <div class="title font-quicksand sample-title">
                        <a target="_blank" href="nav-menus.php"><?php _e( 'Menus', ET_DOMAIN ) ?></a> <span
                                class="description"><?php _e( 'Edit all available menus in your site here.', ET_DOMAIN ) ?></span>
                    </div>

                    <div class="title font-quicksand sample-title">
                        <a href="widgets.php" target="_blank"><?php _e( 'Sidebars & Widgets', ET_DOMAIN ) ?></a> <span
