...
class AE_Category extends AE_Term {
	...
	public function __construct($args = array()){
		...
		$this->icons_list = isset($args['icons_list']) ? $args['icons_list'] : array();
	...
	public function getAll($args = array()){
        ...
        $args   	= wp_parse_args( $args,  array( 'order' => 'DESC','hide_empty' => false ,'pad_counts' => true, 'number' => $number));
 ...
 * @param integer $code returned code
 *
