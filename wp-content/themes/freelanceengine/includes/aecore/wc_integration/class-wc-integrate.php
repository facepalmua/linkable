...
class WC_Integrate
{
    ...
    public function add_hook()
    {
        ...
        add_filter('et_build_payment_visitor', array(self::getInstance(), 'build_payment_visitor'), 10, 4);
	 ...
	 */
    function build_payment_visitor($class, $paymentType, $order, $paymentType_raw)
    {
        if ($class instanceof ET_InvalidVisitor) {
            ...
            if (class_exists("WooCommerce")) {
                ...
                if (array_key_exists($paymentType_raw, $available_payment_gateways)) {
                    $class = new WC_Integrate_Visitor($paymentType_raw);
                }
            }
        }
        return $class;
