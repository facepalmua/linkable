...
class AE_list {
	...
	*/
	function render() {
		...
		?>	
			<input id="confirm_delete_<?php echo $this->params['name']; ?>" value="<?php _e("This selected package may be used by some users. Are you sure you want to remove the package?", ET_DOMAIN); ?>" type="hidden" />
			<!-- add new item form -->
			<div class="item">
