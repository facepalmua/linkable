...
function ae_social_login_settings($pages) {
        ...
        'groups' => array(
            array(
                'args' => array(
                    ...
                    'id' => 'twitter-api',
                    'class' => '',
                    'desc' => __("Enabling this will allow users to log in via Twitter.", ET_DOMAIN)
                ) ,
            ...
            array(
                'args' => array(
                    ...
                    'id' => 'facebook-api',
                    'class' => '',
                    'desc' => __("Enabling this will allow users to log in via Facebook.", ET_DOMAIN)
                ) ,
            ...
            array(
                'args' => array(
                    ...
                    'id' => 'google-api',
                    'class' => '',
                    'desc' => __("Enabling this will allow users to log in via Google.", ET_DOMAIN)
                ) ,
            ...
            array(
                'args' => array(
                    ...
                    'id' => 'linkedin-api',
                    'class' => '',
                    'desc' => __("Enabling this will allow users to log in via LinkedIn.", ET_DOMAIN)
                ) ,
            ...
            array(
                ...
                'fields' => array(
                    array(
                        ...
                        'name' => 'social_connect',
                        'placeholder' => __("eg:http://enginethemes.com/freelanceengine/social-connect", ET_DOMAIN) ,
                        'class' => '',
    ...
    $pages[] = array(
        'args' => array(
            ...
            'icon' => 'B',
            'desc' => __("Setup login by social network accounts", ET_DOMAIN)
        ) ,
        'container' => $orderlist
    );
