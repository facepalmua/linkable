										...
										<div class="service-price">
											<?php
												if($package->et_price > 0) {
													echo "<h2>";ae_price($package->et_price);echo "</h2> ";
													echo "<p>";printf(__(" for %s", ET_DOMAIN), $duration);echo "</p>";
		                        				}else{
		                        					echo "<h2>";_e("FREE", ET_DOMAIN);	echo "</h2> ";
													echo "<p>"; printf(__("for %s", ET_DOMAIN), $duration); echo "</p>";
		                        				}
											?>
										</div>
										<div class="service-info">
											<h3><?php echo $package->post_title; ?></h3><p><?php echo $package->post_content; ?></p>
										</div>
									 	<?php
	    						...
	    						<div class="col-md-4 col-sm-6">
									<div class="fre-service-pricing">
										<div class="service-price">
											<?php
												if($plan->et_price > 0) {
													echo "<h2>";ae_price($plan->et_price);echo "</h2> ";
		                        				}else{
		                        					echo "<h2>";_e("FREE", ET_DOMAIN);echo "</h2> ";
		                        				}
											?>
