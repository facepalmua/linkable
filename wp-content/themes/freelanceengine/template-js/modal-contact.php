    ...
    <div class="modal-dialog">
         <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?php _e( 'Send an email to this freelancer', ET_DOMAIN ); ?></h4>
            </div>
            <div class="modal-body">
                <form role="form" id="submit_contact" class="bid-form fre-modal-form submit_contact">
                    <div class="fre-input-field">
                        <label class="fre-field-title" for="sender_email"><?php _e( 'Your email', ET_DOMAIN ); ?></label>
                        <div class="fre-project-budge2">
                            <input type="text" name="sender_email" required value="<?php echo $email;?>" id="sender_email" class="form-control required"  />
                        </div>
                    </div>
