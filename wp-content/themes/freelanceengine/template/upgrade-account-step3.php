    	...
    	<form class="post" role="form">
            ...
            <div class="form-group">
            	<div class="row">
                    ...
                    <div class="col-sm-8">
                        <input type="number" name="bid_budget" id="bid_budget" class="input-item form-control text-field required number" min="0" >
                    </div>
                </div>
            </div>
            <!--//  bid budget  -->
                    ...
                    <div class="col-sm-8">
                        <div class="row">
                            <div class="col-sm-6 col-xs-6">
                                <input required  type="number" name="bid_time" id="bid_time" class="input-item form-control text-field is_number" min="0">
                            </div>
