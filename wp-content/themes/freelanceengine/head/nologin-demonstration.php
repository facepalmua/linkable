...
<div class="color-right">
	<div class="content-sub">
        ...
        <p>
            <a href="<?php echo et_get_page_link( array('page_type' => 'auth', 'post_title' => __("Create a Profile", ET_DOMAIN )) ); ?>" class="btn-sumary btn-sub-create box-shadow-button-orange">
                <?php _e("Create a Profile", ET_DOMAIN); ?>
            </a>
        </p>
        <?php }else{ ?>
        <p>
            <a href="<?php echo get_post_type_archive_link(PROJECT) ?>" class="btn-sumary btn-sub-create box-shadow-button-orange">
