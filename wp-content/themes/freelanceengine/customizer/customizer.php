...
class Fre_Customize {
   ...
   public static function register ( $wp_customize ) {
      ...
      $wp_customize->add_setting( 'primary_color', //No need to use a SERIALIZED name, as `theme_mod` settings already live under one db record
         array(
            'default'    => '#1fbdbd', //Default setting/value to save
      ...
      $wp_customize->add_control( new WP_Customize_Color_Control( //Instantiate the color control class
         ...
         array(
            'label'      => __( 'Primary Color', ET_DOMAIN ), //Admin-visible name of the control
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( //Instantiate the color control class
        ...
        'fre_secondary_color', //Set a unique ID for the control
            array(
                'label'      => __( 'Secondary Color', ET_DOMAIN ), //Admin-visible name of the control
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( //Instantiate the color control class
         ...
         array(
            'label'      => __( 'Background Header', ET_DOMAIN ), //Admin-visible name of the control
            'settings'   => 'bg_header', //Which setting to load and manipulate (serialized is okay)
            'priority'   => 10, //Determines the order this control appears in for the specified section
            'section'    => 'colors', //ID of the section this control should render in (can be one of yours, or a WordPress default section)
         )
        )
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( //Instantiate the color control class
         ...
         array(
            'label'      => __( 'Color for text in header', ET_DOMAIN ), //Admin-visible name of the control
            'settings'   => 'textcolor_header', //Which setting to load and manipulate (serialized is okay)
            'priority'   => 10, //Determines the order this control appears in for the specified section
            'section'    => 'colors', //ID of the section this control should render in (can be one of yours, or a WordPress default section)
         )
        )
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( //Instantiate the color control class
         ...
         array(
            'label'      => __( 'Background  Footer', ET_DOMAIN ), //Admin-visible name of the control
            'settings'   => 'bg_footer', //Which setting to load and manipulate (serialized is okay)
            'priority'   => 10, //Determines the order this control appears in for the specified section
            'section'    => 'colors', //ID of the section this control should render in (can be one of yours, or a WordPress default section)
         )
      ) );
        ...
        $wp_customize, //Pass the $wp_customize object (required)
            'fre_textcolor_footer', //Set a unique ID for the control
                array(
                    'label'      => __( 'Footer Text color', ET_DOMAIN ), //Admin-visible name of the control
                    'settings'   => 'textcolor_footer', //Which setting to load and manipulate (serialized is okay)
                    'priority'   => 10, //Determines the order this control appears in for the specified section
                    'section'    => 'colors', //ID of the section this control should render in (can be one of yours, or a WordPress default section)
                )
            )
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( //Instantiate the color control class
            ...
            'fre_bg_copyright', //Set a unique ID for the control
                array(
                    'label'      => __( 'Background Copyright', ET_DOMAIN ), //Admin-visible name of the control
                    'settings'   => 'bg_copyright', //Which setting to load and manipulate (serialized is okay)
                    'priority'   => 10, //Determines the order this control appears in for the specified section
                    'section'    => 'colors', //ID of the section this control should render in (can be one of yours, or a WordPress default section)
                )
            )
